/**
 * @file    sony_ecx336.h
 * @brief   Sony display control interface definitions.
 * @ingroup fixation_display_controller
 * @details
 * This header file defines the public interfaces, data types,
 * and command-related declarations for the Sony display control module.
 *
 * It provides task entry functions and control interfaces for
 * display update, animation control, and transition speed adjustment.
 */
