...
void SYS_Init(void)
{
    ...
    /* Set GPIO pins PA8 to PA11 to input mode for PSC 700 gate detection I/O*/
    GPIO_SetMode(PA, BIT8 | BIT9 | BIT10 | BIT11, GPIO_MODE_INPUT); 
...
void timer_setup(){
    ...
    timer_setOneShutPS(TIMER3, 1000); //1us
