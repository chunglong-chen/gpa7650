...
#if defined(RUN_LVGL) && (RUN_LVGL == 1)
...
#define configTOTAL_HEAP_SIZE			        ( ( size_t ) ( 0x1400000) )
#endif
#define configMAX_TASK_NAME_LEN			        ( 24 )
#define configUSE_TRACE_FACILITY		        CMD_OS
...
#define configGENERATE_RUN_TIME_STATS           CMD_OS
#define configUSE_STATS_MEM                     CMD_OS

/* POSIX Support Compatible */
...
#define configSETUP_TICK_INTERRUPT()                                                                                  \
    do                                                                                                                \
    {                                                                                                                 \
		extern int os_timer_setup(unsigned int freq_hz, void (*TimerIsrFunction)(void));								\
        os_timer_setup(configTICK_RATE_HZ, (void *)FreeRTOS_Tick_Handler);												\
    } while (0)
...
#define configINTERRUPT_CONTROLLER_BASE_ADDRESS 0xa2001000UL
